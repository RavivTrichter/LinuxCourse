...
/*
 * message formats: MSG_FINISH_INPUT
 * Used by client to signal the server(may be another client) that he finished to send him input
 * */
typedef struct msg_finish_input  {

    int m_type;                   // = MSG_FINISH_INPUT
